...
function negativeLocalResource!(dP, P, params, t)
    ...
    dP[3] = c₁ * (P₁ - P₁₁ - Pᵤ₁) * (1/z + (z-1)/z * ((P₁ - P₁₁ - Pᵤ₁) / (1 - pᵤ - P₁))) - P₁₁ * (e₁ * (1 + 1/z + ((z-1)/z) * (P₁₁ / P₁)) + μ * P₂)
    dP[4] = c₁ * ((z-1)/z) * (pᵤ - Pᵤ₁ - pᵤᵤ) * ((P₁ - P₁₁ - Pᵤ₁) / (1 - pᵤ - P₁)) - Pᵤ₁ * (e₁ * (1 + (P₁₁ / P₁) * ((z-1)/z)) + μ * P₂)
end
...
# investigate this, oscilatory behaviour increases as you approach that weird point
function testODE!(dP, P, params, t)
    c₁, c₂, e₁, e₂, μ, pᵤ, pᵤᵤ, z = params
    P₁, P₂, P₁₁, Pᵤ₁ = P
    dP[1] = c₁ * (P₁ - P₁₁ - Pᵤ₁) - e₁ * P₁ + P₁₁ * e₁ * eps - μ * P₂
    dP[2] = c₂ * (P₁ - P₂) * P₂ - (e₁ * P₂ * (1 - eps * (P₁₁ / P₁)) + (e₂ + μ) * P₂)
    dP[3] = c₁ * (P₁ - P₁₁ - Pᵤ₁) * (1/z + (z-1)/z * ((P₁ - P₁₁ - Pᵤ₁) / (1 - pᵤ - P₁))) - P₁₁ * (e₁ * (1 - 1/z * eps - ((z-1)/z) * eps * (P₁₁ / P₁)) + μ * P₂)
    dP[4] = c₁ * ((z-1)/z) * (pᵤ - Pᵤ₁ - pᵤᵤ) * ((P₁ - P₁₁ - Pᵤ₁) / (1 - pᵤ - P₁)) - Pᵤ₁ * (e₁ * (1 - (P₁₁ / P₁) * eps * ((z-1)/z)) + μ * P₂)
end
